# chatable OpenAPI Specification
[![Build Status](https://travis-ci.org/walkward/chatable-api.svg?branch=master)](https://travis-ci.org/walkward/chatable-api)
...
6. If you did everything correct, https://walkward.github.io/chatable-api/ will lead to your new docs
...
- Documentation(ReDoc): https://walkward.github.io/chatable-api/
- SwaggerUI: https://walkward.github.io/chatable-api/swagger-ui/
- Look full spec:
    + JSON https://walkward.github.io/chatable-api/swagger.json
    + YAML https://walkward.github.io/chatable-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://walkward.github.io/chatable-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://walkward.github.io/chatable-api/ with url from the message: `Server started <url>`
